...
namespace DotNetFramework
{
    public partial class FrmSolution : Form
    {
        ...
        ToolStripButton BtnSensorToImage;
        ...
        private void InitializeMyContents()
        {
            ...
            BtnSensorToImage = new ToolStripButton() { Name = "SensorToImage", DisplayStyle = ToolStripItemDisplayStyle.Image}; //통신

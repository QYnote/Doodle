    ...
    public partial class FrmSolution : Form
    {
        ...
        private void CallForm(string frmName)
        {
            ...
            switch(frmName)
            {
                ...
                case "CommTest": this._curForm = new CommTester.FrmCommTester() { Name = frmName, Text = this.btnCommTester.Text }; break;
                case "DBConnector": this._curForm = new DataBase.FrmDataBase() { Name = frmName, Text = this.btnDataBase.Text }; break;
                case "Server": this._curForm = new Server.FrmServer() { Name = frmName, Text = this.btnServer.Text }; break;
                case "Chart": this._curForm = new Charts.FrmChart() { Name = frmName, Text = this.btnChart.Text }; break;
            }

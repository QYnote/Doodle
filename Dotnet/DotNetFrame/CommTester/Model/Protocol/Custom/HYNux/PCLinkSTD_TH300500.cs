...
{
    internal class PCLinkSTD_TH300500 : PCLinkBase, Model.Protocol.IProtocol
    {
        ...
        internal PCLinkSTD_TH300500(CommPort handler) : base(handler) { }
        ...
        public override IProtocolResult Extraction(byte[] frame)
        {
            ...
            //1. Header, Tail 제외 추출
            byte[] reqBody = new byte[frame.Length - 4],
                   resBody = new byte[base.Request.Length - 4];

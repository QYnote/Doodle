...
{
    internal class PCLinkSUM_TH300500 : PCLinkBase, Model.Protocol.IProtocol
    {
        DotNet.Comm.Protocols.Customs.HYNux.PCLinkSUM_TH300500 origin = new DotNet.Comm.Protocols.Customs.HYNux.PCLinkSUM_TH300500();
        PCLinkExtractor_TH300500 unpacker = new PCLinkExtractor_TH300500();

        internal PCLinkSUM_TH300500(CommPort handler) : base(handler) { }

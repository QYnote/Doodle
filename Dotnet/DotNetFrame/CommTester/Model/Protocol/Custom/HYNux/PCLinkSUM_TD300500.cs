...
{
    internal class PCLinkSUM_TD300500 : PCLinkBase, Model.Protocol.IProtocol
    {
        DotNet.Comm.Protocols.Customs.HYNux.PCLinkSUM_TD300500 origin = new DotNet.Comm.Protocols.Customs.HYNux.PCLinkSUM_TD300500();
        PCLinkExtractor_TD300500 unpacker = new PCLinkExtractor_TD300500();

        internal PCLinkSUM_TD300500(CommPort handler) : base(handler) { }
